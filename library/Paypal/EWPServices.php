...
class Paypal_EWPServices
{
	 ...
	 * @static
	 */
	public static function encryptButton(	$buttonParams_,
							$ewpCertPath_,
							$ewpPrivateKeyPath_,
							$ewpPrivateKeyPwd_,
							$paypalCertPath_,
							...
							$buttonImageUrl_)
    {
         ...
         */
		$encryptedDataReturn = Paypal_PPCrypto::signAndEncrypt($contentBytes, $ewpCertPath_, $ewpPrivateKeyPath_, $ewpPrivateKeyPwd_, $paypalCertPath_);
