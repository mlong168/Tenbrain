...
print "server string - $_SERVER[PHP_SELF]<br>";
print "htmlspecialchars - ".htmlspecialchars($_SERVER["PHP_SELF"])."<br>";
print "substr - ".substr(htmlspecialchars($_SERVER["PHP_SELF"]), 1)."<br>";
print "Utils::getURL - ".Utils::getURL('PDTResponse.php')."<br>";

$php_self = substr(htmlspecialchars($_SERVER["PHP_SELF"]), 1); // remove the leading /
$returnURL = Utils::getURL(substr_replace($php_self, "PDTResponse.php", strrpos($php_self, '/')));
$cancelURL = Utils::getURL(substr_replace($php_self, "", strrpos($php_self, '/')));
$notifyURL = Utils::getURL(substr_replace($php_self, "IPNListner.php", strrpos($php_self, '/')));
